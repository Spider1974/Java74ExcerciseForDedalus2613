...
public class EmployeeController {
	...
	public void searchEmpById()
	{
		...
		Query qry = session.createNamedQuery("GetEmpByID").setInteger("id", veid);
		employee    emp =(employee) qry.uniqueResult();
		System.out.println("Emp based on eno " + emp);
	}
	public void searchEmpByDNO()
	{
		System.out.println("Enter your ID:");
		int veid = sc.nextInt();

		Query qry = session.createNamedQuery("GetEmpByDno").setInteger("id", veid);
		employee    emp =(employee) qry.uniqueResult();
		System.out.println("Emp based on department " + emp);
	}
	...
	public void searchUsingCriteriaQuery()
	{
		...
		System.out.println("Emp based on email by Criteria Query " + emp);
